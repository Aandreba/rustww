...
doc:
	RUSTFLAGS='-C target-feature=+atomics,+bulk-memory,+mutable-globals' cargo rustdoc --open --target wasm32-unknown-unknown -Z build-std=std,panic_abort -- --cfg docsrs
